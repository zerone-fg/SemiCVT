...
def main():
    ...
    # if os.path.exists(cfg["saver"]["snapshot_dir"] + '/mycode'):
    #     shutil.rmtree(cfg["saver"]["snapshot_dir"] + '/mycode')
    # shutil.copytree('/apdcephfs/private_huiminhuang/U2PL-main/u2pl/models_cnn_trans', cfg["saver"]["snapshot_dir"] + '/mycode', shutil.ignore_patterns(['.git', '__pycache__']))
    # shutil.copytree('/apdcephfs/private_huiminhuang/U2PL-main/u2pl/models_cnn_trans', cfg["saver"]["snapshot_dir"] + '/mycode')
